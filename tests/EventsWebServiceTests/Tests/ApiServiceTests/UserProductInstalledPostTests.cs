...
{
    public class UserProductInstalledPostTests : BaseTest
    {
        [TearDown]
        ...
        public async Task EventIsPostedSuccessfully_When_PostNewProductActionEventWithAllProperties()
        {
            ...
            var request = ProductActionRequestFactory.BuildValidRequest(ProductActionDto, EventType.ProductInstalled);
